<?php
  ...
  function theme_pagelayout () {
    ...
    <body>
      <br />
      <table border="0" width="<?php echo( $page_width ); ?>" cellspacing="0" cellpadding="0" align="center" >
        <tr align="left" valign="top">
          <td width="<?php echo( $page_width ); ?>" colspan="2" bgcolor="#<?php echo(get_user_color('header_bg_color')); ?>">
            <div id="header_image"><img src="<?php echo( $img_path ); ?>bann.gif" alt="" border="0" /></div>
